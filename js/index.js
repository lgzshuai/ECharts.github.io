...
(function() {
	...
	//添加自适应; 实例对象(myChart),来监听window尺寸
		...
		series: [
			{
				name: "访问来源",
				type: "pie",
				//radius圆的内圈半径占比，自适应的整圆半径屏占比
				radius: ["40%", "60%"],
				center: ["50%", "48%"],
				avoidLabelOverlap: false,
				//label图形上的文字是否显示 和 定位到哪里
				label: {
					show: true
					//position: 'center'
				},
...
(function() {
	...
	var color = ["#a6c84c", "#ffa022", "#46bee9","#cc6709", "#09cc71",]; //航线的颜色
	var series = [];
	[
		["西安", XAData],
		["西宁", XNData],
